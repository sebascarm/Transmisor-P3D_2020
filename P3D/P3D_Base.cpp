...
void P3D_Base::Controlar(bool& DatoSimu, bool& DatoLocal, const char* Comando) {
	if (DatoSimu != DatoLocal) {
		...
		EstructuraModificada(Comando, S_DatoSimu);
	}
}
...
void P3D_Base::Controlar(double& DatoSimu, double& DatoLocal, const char* Comando) {
	if (DatoSimu != DatoLocal) {
		DatoLocal = DatoSimu;
		string S_DatoSimu = to_string(DatoSimu);
		EstructuraModificada(Comando, S_DatoSimu);
...
void P3D_Base::EstructuraModificada(string Comando, string Valor) {
