...
namespace Capture.Interface
{
    ...
    public class CaptureInterface : MarshalByRefObject
    {
        ...
        /// </summary>
        // Variables                          
        IntPtr LocalswapChainPtr = (IntPtr)0;
        IntPtr Swap_Usar = (IntPtr)0;
        ...
        // Modificado
        public IAsyncResult BeginGetScreenshot(IntPtr SwapChain_Cap, Rectangle region, TimeSpan timeout, AsyncCallback callback = null, Size? resize = null, ImageFormat format = ImageFormat.Bitmap)
        {
            Swap_Usar = SwapChain_Cap;
        ...
        // Modificado   
        public Screenshot EndGetScreenshot(IAsyncResult result, ref IntPtr SwapChain) {
            SwapChain = LocalswapChainPtr;
        ...
        // Modificado   
        public void SendScreenshotResponse(Screenshot screenshot, IntPtr swapChainPtr) {
            LocalswapChainPtr = swapChainPtr; // almacenamos el swapchainptr
